...
const AnimatedEntry: FC<AnimatedEntryProps> = ({ className }) => {
  return (
    <>
      <h1
        className={`${className} relative overflow-hidden h-[50rem] flex items-end justify-center ml-2 w-[100vw] px-4`}
      >
        ...
        <span className="letters absolute bottom-[2vh] !text-6xl right-20 l7">
          Productions
        </span>
      </h1>
    </>
